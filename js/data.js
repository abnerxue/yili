...
const homeData = [
  {
    ...
    GC_EYWF_BG_PICTUE: {
      TEXT: '背景图片',
      VALUE: '../assets/background/generalBackground.png'
    },
    GC_EYWF_FUNC: [
      {
        GC_EYWF_FUNC_NAME: {
        ...
        GC_EYWF_FUNC_PICTUE: {
          TEXT: '功能显示图片',
          VALUE: '../assets/home/我的福利icon.png'
        }
      },
      {
        GC_EYWF_FUNC_NAME: {
      ...
      },
      {
        ...
        GC_EYWF_FUNC_PICTUE: {
          TEXT: '功能显示图片',
          VALUE: '../assets/home/伊家福礼icon.png'
        }
      }
    ],
    GC_EYWF_POLY: [
      {
        ...
        GC_COST_PICTUE: {
          TEXT: '福利图标',
          VALUE: '../assets/home/高温防暑icon.png'
        },
        GC_EYWL_POLY_COMMT: {
          TEXT: '福利政策解读',
          VALUE: '春节福利'
      ...
      },
      {
        ...
        GC_COST_PICTUE: {
          TEXT: '福利图标',
          VALUE: '../assets/home/生日福礼icon.png'
        },
        GC_EYWL_POLY_COMMT: {
          TEXT: '福利政策解读',
          VALUE: '中秋节'
...
const welfareOverviewDatas = [
  {
    ...
    GC_EYWF_EVNT_PICTURE: {
      TEXT: '活动图片',
      VALUE: '../assets/welfareOverview/位图.png'
    },
    GC_EYWF_EVNT_URL: {
      TEXT: '活动链接',
      VALUE: 'www.baidu.com'
