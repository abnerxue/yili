const EmployeeOption = (function () {
  ...
  function isShowBirthdayImg() {
    ...
    if (birthday.GC_WISH_FG.VALUE === 'Y') {
      $('.receive').append(
        `<div class='birthday-img-wrapper'><img src='../assets/employeeOptionalPayment/生日祝福小牛.png' class='birthday-img'/>
             <img src='../assets/employeeOptionalPayment/guanbi.png' class='close-icon'></img>
           </div>`
      )
