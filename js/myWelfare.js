...
var mywelfare = function () {
  ...
  function init() {
    ...
    request('/WEBLIB_EYWF_LIB.GC_MY_EYWF_LIB.FieldFormula.Iscript_GetMyWfSum', {
      ...
      var _data3 = _slicedToArray2(data, 1),
          realData = _data3[0];
    ...
    request('/WEBLIB_EYWF_LIB.GC_MY_EYWF_LIB.FieldFormula.Iscript_GetMyWfDetail', {
      ...
      var _mywelfareDataDetailD3 = data,
          _mywelfareDataDetailD4 = _slicedToArray2(_mywelfareDataDetailD3, 1),
          realDetailData = _mywelfareDataDetailD4[0];
  ...
  function getDetail() {
    ...
    request('/WEBLIB_EYWF_LIB.GC_MY_EYWF_LIB.FieldFormula.Iscript_GetMyWfDetail', {
      ...
      var _data4 = _slicedToArray2(data, 1),
          realDetailData = _data4[0];
